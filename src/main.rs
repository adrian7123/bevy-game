...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    let ship_handle = asset_server.load("sprites/block_square.png");
    let enemy_a_handle = asset_server.load("sprites/ball_blue_large.png");
    let enemy_b_handle = asset_server.load("sprites/ball_blue_large.png");
